...
nyc <-read.csv("https://raw.githubusercontent.com/fredlapolla/surp21/main/NYC_HANES_DIAB.csv")
...
```{r}
junk <- read.csv("https://raw.githubusercontent.com/fredlapolla/surp21/main/junk.csv")
```
...
nyc <- read.csv("https://raw.githubusercontent.com/fredlapolla/surp21/main/NYC_HANES_DIAB.csv", stringsAsFactors = FALSE)
class(nyc$KEY)
```
