---
title: "Intro to Data Science for BioMedicine: R I"
author: "Fred LaPolla"
date: "June 15, 2021"
output:
...
In plain language this means we can use R to summarize data to find out things like averages, frequencies that different rows fall into certain groupos or do more complex statistical tests.
...
For demo purposes: https://github.com/fredlapolla/surp21
...
Often you will want to refer to a set of data (like the above list of 1 through 10). You can assign a Variable which names some value in R. 
...
nyc <- read.csv("https://raw.githubusercontent.com/fredlapolla/surp21/master/NYC_HANES_DIAB.csv")
```
...
## Review on Mentimeter

***

## Optional problems to cement learning
